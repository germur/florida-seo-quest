          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              ...
              <nav className="text-sm text-background/70 mb-6">
                ...
                <Link href="/case-studies" className="hover:text-background transition-colors">Case Studies</Link>
                <span className="mx-2">/</span>
              ...
              <div className="bg-gradient-to-br from-primary/5 via-secondary/10 to-background border border-border/50 rounded-2xl p-8 shadow-lg">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Link href="/services/strategic-seo-consulting" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-primary/20 transition-all duration-200">
                      ...
                      <Link href="/services/seo-automation" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-primary/20 transition-all duration-200">
                        <div className="p-2 bg-primary/10 rounded-lg group-hover:bg-primary/20 transition-colors">
                      ...
                      <Link href="/services/digital-storytelling-services" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-primary/20 transition-all duration-200">
                        <div className="p-2 bg-primary/10 rounded-lg group-hover:bg-primary/20 transition-colors">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {caseStudy.industry.includes('Property') || caseStudy.industry.includes('Home') ? (
                        <Link href="/services/home-services-seo" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-electric-blue/20 transition-all duration-200">
                      ...
                      {caseStudy.industry.includes('Car') || caseStudy.industry.includes('Local') ? (
                        <Link href="/services/local-seo-optimization" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-electric-blue/20 transition-all duration-200">
                          <div className="p-2 bg-electric-blue/10 rounded-lg group-hover:bg-electric-blue/20 transition-colors">
                      ...
                      {caseStudy.industry.includes('E-commerce') || caseStudy.industry.includes('Jewelry') ? (
                        <Link href="/services/ecommerce-seo" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-electric-blue/20 transition-all duration-200">
                          <div className="p-2 bg-electric-blue/10 rounded-lg group-hover:bg-electric-blue/20 transition-colors">
                            <ArrowUpRight className="h-4 w-4 text-electric-blue" />
                          </div>
                          <div>
                      ...
                      {caseStudy.industry.includes('Education') ? (
                        <Link href="/services/education-seo" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-electric-blue/20 transition-all duration-200">
                          <div className="p-2 bg-electric-blue/10 rounded-lg group-hover:bg-electric-blue/20 transition-colors">
                            <ArrowUpRight className="h-4 w-4 text-electric-blue" />
                          </div>
                          <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Link href="/resources" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-teal/20 transition-all duration-200">
                      ...
                      <Link href="/blog" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-teal/20 transition-all duration-200">
                        <div className="p-2 bg-teal/10 rounded-lg group-hover:bg-teal/20 transition-colors">
                          <ArrowUpRight className="h-4 w-4 text-teal" />
                        </div>
                        <div>
                      ...
                      <Link href="/how-we-work" className="group flex items-center gap-3 p-3 rounded-xl hover:bg-background/80 border border-transparent hover:border-teal/20 transition-all duration-200">
                        <div className="p-2 bg-teal/10 rounded-lg group-hover:bg-teal/20 transition-colors">
                ...
                <div className="mt-10 pt-8 border-t border-border/50">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {caseStudy.industry.includes('Property') ? (
                      <Link href="/case-studies/paramount-property-restoration" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                    ...
                    {(caseStudy.industry.includes('Car') || caseStudy.industry.includes('Local')) && caseStudy.slug !== 'flo-car-rental' ? (
                      <Link href="/case-studies/flo-car-rental" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                        <div className="flex items-start gap-3">
                          <div className="p-1.5 bg-bright-orange/10 rounded-lg">
                    ...
                    {caseStudy.industry.includes('Cleaning') ? (
                      <Link href="/case-studies/puff-cleaning" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                        <div className="flex items-start gap-3">
                          <div className="p-1.5 bg-bright-orange/10 rounded-lg">
                    ...
                    {caseStudy.industry.includes('Education') ? (
                      <Link href="/case-studies/edu1st-preschools" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                        <div className="flex items-start gap-3">
                          <div className="p-1.5 bg-bright-orange/10 rounded-lg">
                            <ArrowUpRight className="h-3 w-3 text-bright-orange" />
                          </div>
                    ...
                    {caseStudy.industry.includes('Jewelry') ? (
                      <>
                        <Link href="/case-studies/craftd-london" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                          <div className="flex items-start gap-3">
                            <div className="p-1.5 bg-bright-orange/10 rounded-lg">
                              <ArrowUpRight className="h-3 w-3 text-bright-orange" />
                            </div>
                        ...
                        <Link href="/case-studies/le-gramme" className="group p-4 rounded-xl border border-border hover:border-bright-orange/30 hover:bg-bright-orange/5 transition-all duration-200">
                          <div className="flex items-start gap-3">
                            <div className="p-1.5 bg-bright-orange/10 rounded-lg">
