                ...
                {FLORIDA_CITIES.map((city, index) => (
                  <div key={index} className="text-center">
                    ...
                    <div className="space-y-1 text-xs">
                      <Link href={`/services/strategic-seo-consulting/${city.slug}`} className="block text-teal hover:underline">
                        Strategic SEO
                      </Link>
                      <Link href={`/services/digital-storytelling-services/${city.slug}`} className="block text-teal hover:underline">
                        Digital Storytelling
                      </Link>
                      <Link href={`/services/seo-automation/${city.slug}`} className="block text-teal hover:underline">
                        SEO Automation
                      </Link>
                      <Link href={`/services/personal-branding-consulting/${city.slug}`} className="block text-teal hover:underline">
                        Personal Branding
                      </Link>
                    </div>
                  </div>
